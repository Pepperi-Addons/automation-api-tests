...
export class LegacyResourcesService {
    ...
    getByKey(resource, key) {
        return this.papiClient.get(`/resources/${resource}/key/${key}`);
    }

    getByUniqueKey(resource, field, key) {
        return this.papiClient.get(`/resources/${resource}/unique/${field}/${key}`);
    }
