...
export class ObjectsService {
    ...
    batchHardDeleteUDT(udtRowsKeyList: number[]): Promise<BatchApiResponse[]> {
        return this.papiClient.post('/user_defined_tables/hard_delete', { InternalIDList: udtRowsKeyList });
    }
