...
export class NeltPerformanceService {
    ...
    public async getItemTotalAmount(
        ...
        const selectorOfItem = this.neltPerformance[nameOfFunctionToLocateSelector](itemName);
    ...
    public async getItemTSAs(
        ...
        const PriceBaseUnitPriceAfter1_Selector = this.neltPerformance[nameOfFunctionToLocateSelector](
        ...
        const PriceDiscountUnitPriceAfter1_Selector = this.neltPerformance[nameOfFunctionToLocateSelector](
        ...
        const PriceGroupDiscountUnitPriceAfter1_Selector = this.neltPerformance[nameOfFunctionToLocateSelector](
        ...
        const PriceManualLineUnitPriceAfter1_Selector = this.neltPerformance[nameOfFunctionToLocateSelector](
        ...
        const PriceTaxUnitPriceAfter1_Selector = this.neltPerformance[nameOfFunctionToLocateSelector](
        ...
        if (at === 'OrderCenter') {
            const NPMCalcMessage_Selector = this.neltPerformance[nameOfFunctionToLocateSelector](
    ...
    public async getItemTSAs_Discount2(
        ...
        const PriceDiscount2UnitPriceAfter1_Selector = this.neltPerformance[nameOfFunctionToLocateSelector](
    ...
    public async getItemTSAs_AOQM_UOM2(
        ...
        const PriceBaseUnitPriceAfter2_Selector = this.neltPerformance[nameOfFunctionToLocateSelector](
        ...
        const PriceDiscountUnitPriceAfter2_Selector = this.neltPerformance[nameOfFunctionToLocateSelector](
        ...
        const PriceTaxUnitPriceAfter2_Selector = this.neltPerformance[nameOfFunctionToLocateSelector](
    ...
    public async getTotalsTSAsOfItem(
        ...
        const PriceTaxTotal_Selector = this.neltPerformance[nameOfFunctionToLocateSelector](
            'PriceTaxTotal_Value',
            nameOfItem,
        );
        ...
        const PriceTaxTotalPercent_Selector = this.neltPerformance[nameOfFunctionToLocateSelector](
        ...
        const PriceTaxTotalDiff_Selector = this.neltPerformance[nameOfFunctionToLocateSelector](
        ...
        const PriceTaxUnitDiff_Selector = this.neltPerformance[nameOfFunctionToLocateSelector](
    ...
    public async searchInOrderCenter(this: Context, nameOfItem: string, driver: Browser): Promise<void> {
        ...
        driver.sleep(0.1 * 1000);
        await neltPerformance.isSpinnerDone();
        await driver.untilIsVisible(neltPerformance.getSelectorOfItemInOrderCenterByName(nameOfItem));
    ...
    public async changeSelectedQuantityOfSpecificItemInOrderCenter(
        ...
        const uomSelector = neltPerformance[`UnitOfMeasure${aoqm ? '2' : ''}_Selector_Value`];
        ...
        if ((await itemUomValue.getText()) !== uomToSet) {
            ...
            driver.sleep(0.05 * 1000);
            await driver.click(
                neltPerformance.getSelectorOfUnitOfMeasureOptionByText(uomToSet, aoqm ? aoqm : undefined),
            );
            driver.sleep(0.1 * 1000);
            await driver.click(neltPerformance.ItemQuantity_NumberOfUnits_Readonly); // clicking on "neutral" element to make the previously selected element de-actived
            driver.sleep(0.1 * 1000);
        ...
        const quantitySelector = neltPerformance.getSelectorOfCustomFieldInOrderCenterByItemName(
        ...
        const numberOfUnits = await (
            await driver.findElement(neltPerformance.ItemQuantity_NumberOfUnits_Readonly)
        ).getAttribute('title');
        driver.sleep(0.5 * 1000);
        await neltPerformance.isSpinnerDone();
        switch (uomValue) {
            ...
            default:
                if (isTotals === 'Totals') {
                    const otherQuantitySelector = neltPerformance.getSelectorOfCustomFieldInOrderCenterByItemName(
                        `ItemQuantity${aoqm ? '' : '2'}_byUOM_InteractableNumber`,
                        nameOfItem,
                    );
                    ...
                    if (aoqm === '2') {
                        const uom1 = await (
                            await driver.findElement(neltPerformance.UnitOfMeasure_Selector_Value)
                        ).getText();
                        ...
                        const uom2 = await (
                            await driver.findElement(neltPerformance.UnitOfMeasure2_Selector_Value)
                        ).getText();
    ...
    public async changeSelectedQuantityOfSpecificItemInCart(
        ...
        const neltPerformance = new NeltPerformance(driver);
        driver.sleep(0.05 * 1000);
        let itemUomValue = await driver.findElement(neltPerformance.getSelectorOfUomValueInCartByItemName(nameOfItem));
        if ((await itemUomValue.getText()) !== uomValue) {
            await itemUomValue.click();
            driver.sleep(0.05 * 1000);
            await driver.click(neltPerformance.getSelectorOfUnitOfMeasureOptionByText(uomValue));
            driver.sleep(0.1 * 1000);
            await driver.click(neltPerformance.HtmlBody);
            driver.sleep(0.1 * 1000);
            itemUomValue = await driver.findElement(neltPerformance.getSelectorOfUomValueInCartByItemName(nameOfItem));
        }
        driver.sleep(0.05 * 1000);
        await neltPerformance.isSpinnerDone();
        expect(await itemUomValue.getText()).equals(uomValue);
        let uomXnumber = await driver.findElement(
            neltPerformance.getSelectorOfCustomFieldInCartByItemName(
        ...
        const numberOfUnits = await driver.findElement(
            neltPerformance.getSelectorOfNumberOfUnitsInCartByItemName(nameOfItem),
        );
        driver.sleep(1 * 1000);
        switch (uomValue) {
            case 'Each':
    ...
    public async searchInAccounts(this: Context, nameOfItem: string, driver: Browser): Promise<void> {
        const neltPerformance = new NeltPerformance(driver);
        await neltPerformance.isSpinnerDone();
        const searchInput = await driver.findElement(neltPerformance.AccountsSearchbox);
        await searchInput.clear();
        driver.sleep(0.1 * 1000);
        await searchInput.sendKeys(nameOfItem + '\n');
        driver.sleep(0.5 * 1000);
