    ...
    async publishDataIndex() {
        const hardcodedBody = {
            all_activities_fields: [
                ...
                {
                    fieldID: 'Account.InternalID',
                    type: 'Integer',
                },
                {
                    fieldID: 'Account.UUID',
                    type: 'String',
                },
                {
                    fieldID: 'Account.ExternalID',
                    type: 'String',
                },
                {
                ...
                {
                    fieldID: 'Account.City',
                    type: 'String',
                },
                {
                    fieldID: 'Account.Country',
                    type: 'String',
                },
                {
                ...
                {
                    fieldID: 'Agent.ExternalID',
                    type: 'String',
                },
                {
                    fieldID: 'Agent.FirstName',
                    type: 'String',
                },
                {
                    fieldID: 'Agent.Mobile',
                    type: 'String',
                },
            ],
            transaction_lines_fields: [
                ...
                {
                    fieldID: 'Item.InternalID',
                    type: 'Integer',
                },
                {
                    fieldID: 'Item.ExternalID',
                    type: 'String',
                },
                {
                    fieldID: 'Item.Name',
                ...
                {
                    fieldID: 'Transaction.InternalID',
                    type: 'Integer',
                },
                {
                    fieldID: 'Transaction.StatusName',
                    type: 'String',
                },
                {
                ...
                {
                    fieldID: 'Transaction.Account.InternalID',
                    type: 'Integer',
                },
                {
                    fieldID: 'Transaction.Account.UUID',
                    type: 'String',
                },
                {
                ...
                {
                    fieldID: 'Transaction.Account.Name',
                    type: 'String',
                },
                {
                ...
                {
                    fieldID: 'Transaction.Agent.InternalID',
                    type: 'Integer',
                },
                {
                    fieldID: 'Transaction.Agent.UUID',
                    type: 'String',
                },
                {
                    fieldID: 'Transaction.Agent.Name',
                    type: 'String',
                },
                {
                    fieldID: 'LineNumber',
                ...
                {
                    fieldID: 'Transaction.ExternalID',
                    type: 'String',
                },
                {
                    fieldID: 'Transaction.Remark',
                    type: 'String',
                },
                {
                    fieldID: 'Transaction.CreationDateTime',
                    type: 'DateTime',
                },
                {
                    fieldID: 'Transaction.SubTotal',
                    type: 'Double',
                },
                {
                    fieldID: 'Transaction.Status',
                    type: 'Integer',
                },
                {
                    fieldID: 'Transaction.DiscountPercentage',
                    type: 'Double',
                },
                {
                    fieldID: 'Transaction.Account.ZipCode',
                    type: 'String',
                },
                {
                    fieldID: 'Transaction.Account.Status',
                    type: 'Integer',
                },
                {
                    fieldID: 'Transaction.Account.City',
                    type: 'String',
                },
                {
                    fieldID: 'Transaction.Agent.ExternalID',
                    type: 'String',
                },
                {
                    fieldID: 'Transaction.Agent.FirstName',
                    type: 'String',
                },
                {
                    fieldID: 'Transaction.Agent.Mobile',
                    type: 'String',
                },
            ],
            RunTime: null,
