...
export class SurveyPicker extends AddonPage {
    public radioButtonKeySurvey: By = By.xpath(
        "//span[@id='Key' and contains(text(),'{placeholder}')]//..//..//..//..//..//..//mat-radio-button",
    );
    public radioButtonKeyAccount: By = By.xpath(
        "//span[contains(text(),'{placeholder}')]//..//..//..//..//..//..//mat-radio-button",
    );
    ...
    public async selectSurvey(surveyKey) {
        const xpathQueryForRadioButtonOfSurvey: string = this.radioButtonKeySurvey
            .valueOf()
    ...
    public async selectAccount(accountName) {
        const xpathQueryForRadioButtonOfAccount: string = this.radioButtonKeyAccount
            .valueOf()
            ['value'].replace('{placeholder}', accountName);
        await this.browser.click(By.xpath(xpathQueryForRadioButtonOfAccount));
        await this.browser.click(this.doneButton);
        const isSurveyPageOpen = this.browser.untilIsVisible(this.surveyPageLabel, 9000);
