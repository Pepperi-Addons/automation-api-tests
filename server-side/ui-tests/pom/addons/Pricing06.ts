export class PricingData06 {
    ...
    public documentsIn_PPM_Values = {
        ...
        'ZDS1@A001@Spring Loaded Frizz-Fighting Conditioner': `[[true,"1555891200000","2534022144999","1","1","ZDS1_A001",[[2,"D",5,"%"],[5,"D",10,"%"],[20,"D",15,"%"]]]]`,
        'ZDS2@A002@Acc01@ToBr55': `[[true,"1555891200000","2534022144999","1","","Free Goods",[[5,"D",100,"%","",1,"EA","ToBr10",0],[20,"D",100,"%","",1,"CS","ToBr55",0]],"EA"]]`,
        'ZDS3@A001@Drug0002': `[[true,"1555891200000","2534022144999","1","","additionalItem",[[10,"D",100,"%","",2,"CS","Drug0002",0]],"CS"]]`,
        'ZDS3@A001@Drug0004': `[[true,"1555891200000","2534022144999","1","","additionalItem",[[3,"D",100,"%","",2,"EA","Drug0002",0]],"CS"]]`,
        'ZGD1@A002@Acc01@MakeUp003': `[[true,"1555891200000","2534022144999","1","","ZGD1_A002",[[10,"D",20,"%"]],"EA"]]`,
        'ZGD1@A003@Acc01@Beauty Make Up': `[[true,"1555891200000","2534022144999","1","","additionalItem",[[12,"D",100,"%","",1,"EA","MakeUp018",0]],"EA"]]`,
        'ZGD2@A002@Acc01@MakeUp018': `[[true,"1555891200000","2534022144999","1","","additionalItem",[[2,"D",100,"%","",1,"EA","MakeUp018",0]],"EA"]]`,
        'ZGD2@A003@Acc01@Beauty Make Up': `[[true,"1555891200000","2534022144999","1","","ZGD2_A003",[[3,"D",3,"%"],[7,"D",7,"%"]],"EA"]]`,
    ...
    public testItemsValues = {
        ...
        Drug0002: {
            ...
            PriceBaseUnitPriceAfter1: {
                Acc01: { baseline: 30 * 6, '9case(54units)': 30 * 6, '10cases(60units)': 30 * 6, additional: 30 * 6 },
                OtherAcc: { baseline: 31.25, '9case(54units)': 31.25, '10cases(60units)': 31.25, additional: 31.25 },
            },
            PriceDiscountUnitPriceAfter1: {
                Acc01: { baseline: 30 * 6, '9case(54units)': 30 * 6, '10cases(60units)': 30 * 6, additional: 0.0 },
        ...
        Drug0004: {
            ...
            PriceBaseUnitPriceAfter1: {
                Acc01: { baseline: 30 * 6, '2case(12units)': 30 * 6, '3cases(18units)': 30 * 6 },
