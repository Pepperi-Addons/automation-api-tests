export class ListAbiTestData {
    constructor(
        ...
        this['32. ReferenceAccount - 2 Views'] = {
        ...
        this['35. ArraysOfPrimitives - Numbers, Names, Reals'] = {
        ...
        this['36. ContainedArray - Scheme Only: Name, Age'] = {
    ...
    public '32. ReferenceAccount - with 2 Views';
    public '33. FiltersAccRef - with 2 Views';
