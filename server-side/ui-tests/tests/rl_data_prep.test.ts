                ...
                fieldsOfCollection: [
                    {
                        ...
                        mandatory: false,
                        indexed: false,
                        fieldDescription: 'field of name',
                    },
                    {
                        classType: 'Primitive',
                        ...
                        mandatory: false,
                        indexed: false,
                        fieldDescription: 'field of exist',
                    },
                    {
                        classType: 'Primitive',
                        ...
                        mandatory: false,
                        indexed: false,
                        fieldDescription: 'field of amount',
                    },
                    {
                        classType: 'Primitive',
                        ...
                        mandatory: false,
                        indexed: false,
                        fieldDescription: 'field of price',
                    },
                    {
                        classType: 'Primitive',
                ...
                fieldsOfCollection: [
                    {
                        ...
                        fieldType: 'String',
                        mandatory: false,
                        fieldDescription: 'list of products',
                    },
                    {
                        classType: 'Array',
                        fieldName: 'names',
                        fieldType: 'Integer',
                        mandatory: false,
                        fieldDescription: 'in stock quantity',
                    },
                    {
                        classType: 'Array',
                        fieldName: 'reals',
                        fieldType: 'Double',
                        mandatory: false,
                        fieldDescription: 'average items sold per month',
                    },
                ],
                descriptionOfCollection: 'Created with Automation',
            });
