...
export async function SurveyTests(email: string, password: string, client: Client, varPass) {
    ...
    const testData = {
        ...
        configurations: ['84c999c3-84b7-454e-9a86-71b7abc96554', '1.0.22'], //locked because config 1.x.y is for open sync
        Pages: ['50062e0c-9967-4ed4-9102-f2bc50602d41', ''],
        ...
        sync: ['5122dc6d-745b-4f46-bb8e-bd25225d350a', '3.0.97'], //locked because sync 2.x.y is for open sync
        'Core Data Source Interface': ['00000000-0000-0000-0000-00000000c07e', ''],
        'Core Resources': ['fc5a5974-3b30-4430-8feb-7d5b9699bc9f', ''],
