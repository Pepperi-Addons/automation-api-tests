...
/*  To run the test using the CLI - turn on debugger mode (F5 on windows OR (at top bar): Run -> Start Debugging)
    ...
    PROD - 
npm run ui-show-report --server=prod --chrome_headless=false --user_email='test.user.qa@pepperitest.com' --user_pass='Aa123456' --var_pass='VarQA@pepperitest.com:8n@V5X' --tests='Example'
    
    STAGE -
npm run ui-show-report --server=stage --chrome_headless=false --user_email='test.user.qa.stage@pepperitest.com' --user_pass='Aa123456' --var_pass='VarQA@pepperitest.com:u6P8C#' --tests='Example'
    
    EU -
npm run ui-show-report --server=eu --chrome_headless=false --user_email='test.user.qa.eu@pepperitest.com' --user_pass='Aa123456' --var_pass_eu='VarQAEU@pepperitest.com:3#JSSt' --var_pass='VarQA@pepperitest.com:8n@V5X' --tests='Example'
