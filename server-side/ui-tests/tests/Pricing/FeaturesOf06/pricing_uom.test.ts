...
*/
    ...
    if (installedPricingVersionShort !== '5') {
        describe(`Pricing ** UOM ** UI tests  - ${client.BaseURL.includes('staging') ? 'STAGE' : client.BaseURL.includes('eu') ? 'EU' : 'PROD'
                        ...
                        describe('UOMs', () => {
                            ...
                            describe('CART', function () {
                                ...
                                uomTestCartItems.forEach((uomTestCartItem) => {
                                    it(`${uomTestCartItem.name.includes('Free') && account === 'OtherAcc'
