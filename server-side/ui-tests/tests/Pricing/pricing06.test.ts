                ...
                describe(`ACCOUNT "${account == 'Acc01' ? 'My Store' : 'Account for order scenarios'}"`, function () {
                    ...
                    describe('Multiple Values', () => {
                        ...
                        describe('CART', function () {
                            ...
                            it('verifying that the sum total of items in the cart is correct', async function () {
                                let numberOfItemsInCart = multipleValuesTestItems.length + uomTestCartItems.length;
                                if (account === 'OtherAcc') {
                                    numberOfItemsInCart--;
                                }
                                base64ImageComponent = await driver.saveScreenshots();
                                    ...
                                    describe(`CART`, function () {
                                        ...
                                        it('verifying that the sum total of items in the cart is correct', async function () {
                                            let numberOfItemsInCart =
                                                totalsTestItems.length + multipleValuesTestItems.length;
                                            account === 'Acc01'
                    ...
                    // describe('Partial Value (Hierarchy)', () => {});
