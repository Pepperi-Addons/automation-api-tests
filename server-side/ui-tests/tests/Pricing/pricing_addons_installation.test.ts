...
export async function PricingAddonsUpsert(varPass: string, client: Client, prcVer = '') {
    ...
    const testData = {
        ...
        'WebApp API Framework': ['00000000-0000-0000-0000-0000003eba91', `${prcVer?.startsWith('0.5') ? '17.20.%' : ''}`], //CPAS | dependency > 17.3
        'Cross Platform Engine': ['bb6ee826-1c6b-4a11-9758-40a46acb69c5', `${prcVer?.startsWith('0.5') ? '1.4.%' : ''}`], //CPI-NODE (Cross Platform Engine) | dependency > 1.5.39
