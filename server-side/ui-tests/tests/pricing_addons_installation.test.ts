...
export async function PricingAddonsUpsert(varPass: string, client: Client) {
    ...
    const testData = {
        ...
        // 'Cross Platform Engine': ['bb6ee826-1c6b-4a11-9758-40a46acb69c5', '1.4.%'], //CPI-NODE (Cross Platform Engine) | dependency > 1.5.39
