    ...
    describe('Login Performance Tests Suites', () => {
        ...
        describe('Basic UI Tests Suit', async function () {
            ...
            it(`Testing All Collected Results: is the timing increased by 120% or more of the averages + is the timing decreased by 10% or more than the averages`, async function () {
                ...
                addContext(this, {
                    title: `THS RUN avarage duration of loggin in AFTER reloading: ${reloadingAVG}, current ADAL AVG: XXX, in seconds: ${(
                        reloadingAVG / 1000
                    ).toFixed(3)}`,
                    value: `THS RUN avarage duration of loggin in AFTER reloading: ${reloadingAVG}, current ADAL AVG: XXX, in seconds: ${(
                        reloadingAVG / 1000
                    ).toFixed(3)}`,
                });
