...
export async function VFdataPrep(varPass: string, client: Client) {
    ...
    // await generalService.baseAddonVersionsInstallation(varPass, generalService.testDataWithNewSync);
    //#regression Upgrade visit flow dependencies

    const testData = {
        VisitFlow: ['2b462e9e-16b5-4e7a-b1e6-9e2bfb61db7e', '0.6.36'],
        // Nebula: ['00000000-0000-0000-0000-000000006a91', '1.0.19'],
        sync: ['5122dc6d-745b-4f46-bb8e-bd25225d350a', '0.7.%'], // dependency > 0.2.58
        ...
        // 'Cross Platforms API': ['00000000-0000-0000-0000-000000abcdef', '9.6.31'], // CPAPI
