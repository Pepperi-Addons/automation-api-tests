    ...
    describe('Login Performance Tests Suites', () => {
        ...
        describe('Basic UI Tests Suit', async function () {
            ...
            it('Calling Kill Sqlite Job In Jenkins POC', async function () {
                ...
                const jenkinsResponse = await generalService.fetchStatus('https://admin-box.pepperi.com/job/API%20Testing%20Framework/job/e2e%20Bug%20Verification/job/testing_calling_URL/build?token=testing123',
                    {
                        method: 'GET',
                        headers: {
