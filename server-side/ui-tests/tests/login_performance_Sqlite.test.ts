...
//     //GLOBALS
//     const _sumOfDurationAfterRecycling = 0;
//     const _sumODurationNoRecycle = 0;
//     const numOfRuns = 10;
//     const _adalNoRecBaseLine = 0;
//     const _adalWithRecBaseLine = 0;
...
//                 await driver.quit();
//             });
//             it('Calling Kill Sqlite Job In Jenkins POC', async function () {
//                 const user = 'evgeny.v@pepperi.com';
//                 const pass = 'Neska@@@1994';
//                 const base64encodedData = Buffer.from(user + ':' + pass).toString('base64');
//                 const jenkinsResponse = await generalService.fetchStatus(
//                     'https://admin-box.pepperi.com/job/API%20Testing%20Framework/job/e2e%20Bug%20Verification/job/testing_calling_URL/build?token=testing123',
//                     {
//                         method: 'GET',
//                         headers: {
...
//                     },
//                 );
//                 expect(jenkinsResponse.Status).to.equal(201);
//                 expect(jenkinsResponse.Ok).to.equal(true);
//                 expect(jenkinsResponse.Headers.location).to.include('https://admin-box.pepperi.com/queue/item/');
//                 const jenkinsLocationSplit = jenkinsResponse.Headers.location.split('/');
//                 const jenkinsRunQueueNumber = jenkinsLocationSplit[jenkinsLocationSplit.length - 2];
//                 expect(jenkinsRunQueueNumber).to.be.a('number');
//                 debugger;
//             });
