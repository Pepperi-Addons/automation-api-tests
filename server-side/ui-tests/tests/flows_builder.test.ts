...
export async function FlowTests(email: string, password: string, client: Client, varPass) {
    ...
    const firstStepScript = { actualScript: `export async function main(data){return data.first;}`, scriptName: 'firstScriptForFlowStep', scriptDesc: "forFlow", params: firstScriptParam };
    const secondScriptParam = { name: 'second', desc: "test", type: 'String' };
    const secondStepScript = { actualScript: `export async function main(data){return data.second + "XXX";}`, scriptName: 'secondScriptForFlowStep', scriptDesc: "forFlow", params: secondScriptParam };
