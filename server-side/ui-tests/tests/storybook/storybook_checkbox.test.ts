...
export async function StorybookCheckboxTests() {
    ...
    describe('Storybook "Checkbox" Tests Suite', function () {
        ...
        describe('* Checkbox Component * Initial Testing - ***BUG: DI-25771 at "additionalValue" input', () => {
        ...
        checkboxInputs.forEach(async (input) => {
            switch (input) {
                case 'additionalValue': // to be removed when the bug is fixed
                    describe(`INPUT: '${input} - ***BUG: DI-25771'`, async function () {
                        it(`https://pepperi.atlassian.net/browse/DI-25771`, async function () {
                            // https://pepperi.atlassian.net/browse/DI-25771
                        ...
                        switch (input) {
                            ...
                            case 'disabled':
                                ...
                                it(`making sure current value is "False"`, async function () {
                                    ...
                                    await driver.click(checkbox.MainHeader);
                                    const mainExampleCheckbox = await driver.findElement(checkbox.MainExampleCheckbox);
                                    const mainExampleCheckboxDisabled = await mainExampleCheckbox.getAttribute(
                                        'disabled',
                                    );
                                    console.info(
