...
export class PageClass {
	...
	addBlockToSection(blockKey: string, sectionKey: string, column?: number, hide?: Array<DataViewScreenSize>): void {
	...
	addNewBlockToSection(pageBlock: PageBlock, sectionKey: string, column?: number, hide?: Array<DataViewScreenSize>) {
		this.addNewBlock(pageBlock);
