    ...
    async function addDataToTableOverwriteTrue() {
        ...
        for (let index = 0; index <= num; index++) {
            if (
                ...
                logcash.addDataToTableOverwriteTrue[index].Details.includes(
    ...
    async function add50InsertsToTableOverwriteFalse() {
        ...
        for (let index = 0; index <= num; index++) {
            if (
                ...
                logcash.add50InsertsToTableOverwriteFalse[index].Details.includes(
                    'Provided list of item keys contains duplicates',
                )
            ) {
                tst++;
    ...
    async function pageSizeChngesOverwriteFalse() {
        ...
        for (let index = 0; index <= num; index++) {
            if (
                ...
                logcash.pageSizeChngesOverwriteFalse[index].Details.includes(
                    'Provided list of item keys contains duplicates',
                )
            ) {
                tst++;
