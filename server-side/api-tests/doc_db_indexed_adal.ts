...
export async function DocDBIndexedAdalTestser(generalService: GeneralService, request, tester: TesterFunctions) {
    await DocDBIndexedAdal(generalService, request, tester);
}
