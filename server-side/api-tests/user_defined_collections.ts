...
export async function UDCTests(generalService: GeneralService, request, tester: TesterFunctions) {
    ...
    const testData = {
        ...
        'Core Data Source Interface': ['00000000-0000-0000-0000-00000000c07e', ''], //advanced version 0.7.9 contains a bug (DI-23581)
        'Generic Resource': ['df90dba6-e7cc-477b-95cf-2c70114e44e0', ''],
        'Core Resources': ['fc5a5974-3b30-4430-8feb-7d5b9699bc9f', ''], //advanced version 0.7.37 contains a bug (DI-23581)
